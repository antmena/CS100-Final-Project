...
{
    public:
	Weapon *create_primary() { return new vandal; }
	Weapon *create_secondary() { return new sheriff; }
};

class DuelistWeaponFactory : public Factory 
{
    public:
	Weapon *create_primary() { return new phantom; }
	Weapon * create_secondary() { return new ghost; }
};
